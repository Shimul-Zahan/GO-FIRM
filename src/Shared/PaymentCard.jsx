...
const PaymentCard = () => {
    return (
        ...
        <div className="max-w-[370px] h-[270px] mx-auto bg-gradient-to-r from-blue-600 to-blue-400 overflow-hidden rounded-xl p-8 shadow-lg relative transform rotate-1 hover:rotate-0 transition-transform duration-300">
