    ...
    return (
        <div>
            <div className="relative">
                <div className='flex justify-between items-center pb-10 p-10'>
                ...
                <div className='lg:w-full mx-auto px-10'>
                    <form onSubmit={addCategory}>
                        <div className='space-y-8'>
                            <div className='relative'>
                                <input onChange={(e) => setName(e.target.value)} required type="text" name='name' placeholder='Meat' className='border border-black py-3 px-5 w-full' />
                                <h1 className='absolute -top-2 left-4 px-1 bg-white text-sm'>Category</h1>
                            </div>
                            <div className='relative'>
                                <input onChange={(e) => setSubName(e.target.value)} required type="text" name='sub-name' placeholder='Beaf Meat' className='border border-black py-3 px-5 w-full' />
                                <h1 className='absolute -top-2 left-4 px-1 bg-white text-sm'>Sub Category</h1>
                            </div>
                            <div className=" my-10 ">
                                {showName?.name ? (
                                ...
                                <input required ref={fileInputRef} onChange={(e) => {
