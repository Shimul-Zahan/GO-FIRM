...
const Footer = () => {
    return (
        <footer className="bg-[#23403d] mt-5">
            <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-start items-center gap-2">
                            <img src={logo} alt="" />
                            <h1 className='text-5xl font-bold text-white'>GOFIRM</h1>
                        </div>

                        <p className="mt-4 max-w-xs text-white">
                            GvBuySell is the best website to buy Digital goods and services, the most available PVA Google Voice & Social networks accounts, Gmail, Yahoo, Outlook, aol etc.
                        </p>
