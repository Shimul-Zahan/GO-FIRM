        ...
        <>
            ...
            <div className='max-w-7xl mx-auto py-10'>
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8 mb-10">
                    <div className="">
                        <img src="https://shofi-grocery.vercel.app/images/product/product-2.jpg" alt="" />
                    </div>
                    <div className="space-y-5 lg:px-10">
                        <h1 className='text-sm'>Frozen Foods</h1>
                        ...
                        <p className='text-lg'>In a botanical sense, a fruit is the fleshy or dry ripened ovary of a flowering plant, enclosing the... <span className='text-green-300 font-bold'>See more</span></p>
