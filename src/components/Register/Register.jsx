...
const SignUP = () => {
    ...
    const registration = async (e) => {
        e.preventDefault();
        const user = {
            name, email, password, image: showName
        }
                    ...
                    <form onSubmit={registration}>
                        ...
                        <div className='space-y-8'>
                            <div className='relative'>
                                <input type="text" onChange={(e) => setName(e.target.value)} placeholder='Shimul Zahan ' className='border border-black py-3 px-5 w-full' />
